...
class NBModel: 
        ...
        #Feature vector is a simple list like the ones that we use to train the classifier
                ...
                self.outputFile.write("Probability of collaboration:" + " " + str(probabilityPerLabel["y"]/totalProbability) + "\n")              
        ...
        def TestClassify(self): #Method to test the classifier from test file
                ...
                self.outputFile.write("Correct Percentage: " + str(100*(self.correct/(self.wrong + self.correct)))+" %")
...
if __name__ == "__main__":            
            ...
            model.TestClassify()
            print str(model.correct/(model.wrong + model.correct))